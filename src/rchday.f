...
!!    added for binary files 3/25/09 gsm line below and write (77777
 ...
 5000 format ('REACH ',i4,1x,i8,1x,i5,58e12.4)
 5001 format ('REACH ',i4,1x,i8,1x,i5,1x,i5,58e12.4,i6)
 5002 format ('REACH ',i4,1x,i8,2x,i2,1x,i2,1x,i4,1x,58e12.4)
 6000 format ('REACH ',i4,1x,i8,1x,i5,58e12.4,1x,i4)
 6002 format ('REACH ',i4,1x,i8,1x,i2,1x,i2,1x,i4,1x,58e12.4,1x,i4)
      end