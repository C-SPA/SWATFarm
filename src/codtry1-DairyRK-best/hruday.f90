...
!   added for the nitrious oxide all soil layers
      pdvas(79) = nitr_oxide(j)
	  pdvas(80) = nitr(j)
	  pdvas(81) = n2_den(j)
	  pdvas(82) = sol_org_n(j)
	  pdvas(83) = sol_N_min(j)
      pdvas(84) = sol_P_min(j)
	  pdvas(85) = total_N_barn  
	  pdvas(86) = total_P_barn
	  pdvas(87) = total_N_past
	  pdvas(88) = total_P_past
	  pdvas(89) = Norg_barn 
	  pdvas(90) = Nmin_barn
	  pdvas(91) = Porg_barn
      pdvas(92) = Pmin_barn
     ...
     &       (pdvs(ii), ii = 1, itots)
1002  format (a4,i5,1x,a5,a4,i5,1x,i4,1x,i2,1x,i2,1x,i4,1x,e12.4,       &
     & 66f10.3,1x,e10.5,1x,e10.5,8e10.3,2f10.3,4f10.3,6f10.3)
...
1003  format(a4,i5,1x,a5,a4,i5,1x,i4,1x,i2,1x,i2,1x,i4,1x,e12.4,66f10.3,&
     &1x,e10.5,1x,e10.5,8e10.3,f10.3,4f10.3,6f10.3,1x,i4)
        end if
      else
        if (iscen == 1 .and. isproj == 0) then
        if(icalen == 0)write (28,1000) cropname, j, subnum(j), hruno(j),&
...
1000  format (a4,i5,1x,a5,a4,i5,1x,i4,1x,i4,e12.4,66f10.3,1x,e10.5,1x,  &
     &                        e10.5,8e10.3,2f10.3,4f10.3,2f10.3,1x,i4)
1001  format (a4,i5,1x,a5,a4,i5,1x,i4,1x,i4,e12.4,66f10.3,1x,e10.5,1x,  &
     &                              e10.5,8e10.3,2f10.3,6f10.3,4f10.3,14f10.3)
