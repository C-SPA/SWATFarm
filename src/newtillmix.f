...
!! phosphorus changes 2/4/2015 gsm per mjw
!!    manratio    |kg/ha         | manure on manure covered portion only (ratio)
!!    ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!!      real :: smix(22+npmx+12)        !CB 12/2/09 thtill is not used. mjw rev 490
      !!=============   
      real :: smix(27+npmx+12)        !CB 12/2/09 thtill is not used. mjw rev 490
...
!! phosphorus changes 2/4/2015 gsm per mjw
          ...
          !! Manure Layer MJW 11/16/12 Note not compatable with cswat = 2 (arrays will overlap)
          if (manp_flag == 1 .and. l==1 .and. cswat ==0)then ! other layers do not have these surface pools
              smix(23) = smix(23) + mansip(jj) * WW1
              smix(24) = smix(24) + manwip(jj) * WW1
              smix(25) = smix(25) + mansop(jj) * WW1
              smix(26) = smix(26) + manwop(jj) * WW1
              smix(27) = smix(27) + man_dry(jj) * WW1
              smix(28) = smix(28) + man_cov(jj) * WW1
          end if
...
!! phosphorus changes 2/4/2015 gsm per mjw
          ...
          !! Manure Layer MJW 11/16/12 Note not compatable with cswat = 2 (arrays will overlap)
          if (manp_flag == 1 .and. cswat == 0)then ! other layers do not have these surface pools
              if (l==1) then
                mansip(jj) = mansip(jj) * WW3 + smix(23) * WW4
                manwip(jj) = manwip(jj) * WW3 + smix(24) * WW4
                mansop(jj) = mansop(jj) * WW3 + smix(25) * WW4
                manwop(jj) = manwop(jj) * WW3 + smix(26) * WW4
                man_dry(jj) = man_dry(jj)  * WW3 + smix(27) * WW4
                man_cov(jj) = man_cov(jj)  * WW3 + smix(28) * WW4
              else
                ! pool does not exist subsurface, move the nutrients elsewhere
                ! Water Solubles to SOLP
                sol_solp(l,jj) = sol_solp(l,jj) + smix(24) * WW4
                sol_solp(l,jj) = sol_solp(l,jj) + smix(26) * WW4
                ! inorganic insoluble to active
                sol_actp(l,jj) = sol_actp(l,jj) + smix(23) * WW4
                ! Stable Organic to Organic
                sol_orgp(l,jj) = sol_orgp(l,jj) + smix(25) * WW4
                ! manure to residue pool
                ! change below per MJW 6/11/2015 "*" to "+"
                !sol_rsd(l,jj) = sol_rsd(l,jj) *  smix(27) * WW4
                sol_rsd(l,jj) = sol_rsd(l,jj) +  smix(27) * WW4
              end if
              if (mansip(jj) < 1.e-10) mansip(jj) = 1.e-10
              if (manwip(jj) < 1.e-10) manwip(jj) = 1.e-10
              if (mansop(jj) < 1.e-10) mansop(jj) = 1.e-10
              if (manwop(jj) < 1.e-10) manwop(jj) = 1.e-10
              if (man_dry(jj) < 1.e-10) man_dry(jj) = 1.e-10
              if (man_cov(jj) < 1.e-10) man_cov(jj) = 1.e-10
          end if
