...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      !! watershed summations
        ...
        wshddayo(114) = wshddayo(114)+TotalNP_barn * hru_dafr(j)		
        wshddayo(115) = wshddayo(115)+total_N_barn * hru_dafr(j) 
   		wshddayo(116) = wshddayo(116)+total_P_barn * hru_dafr(j) 
        wshddayo(117) = wshddayo(117)+total_N_past * hru_dafr(j) 
        wshddayo(118) = wshddayo(118)+total_P_past * hru_dafr(j) 
        wshddayo(119) = wshddayo(119) + Norg_barn * hru_dafr(j) 
        wshddayo(120) = wshddayo(120) + Nmin_barn * hru_dafr(j)		
        wshddayo(121) = wshddayo(121) + Porg_barn * hru_dafr(j)
	    wshddayo(122) = wshddayo(122) + Pmin_barn * hru_dafr(j)
   		wshddayo(123) = wshddayo(123) + Norg_past * hru_dafr(j)		
   		wshddayo(124) = wshddayo(124) + Nmin_past * hru_dafr(j)
   		wshddayo(125) = wshddayo(125) + Porg_past * hru_dafr(j)
   		wshddayo(126) = wshddayo(126) + Pmin_past * hru_dafr(j)		
   		wshddayo(127) = wshddayo(127) + Frt_Man
   		wshddayo(128) = wshddayo(128) + HPN_calf
   		wshddayo(129) = wshddayo(129) + HPN_HFD
   		wshddayo(130) = wshddayo(130) + HPN_HSD
   		wshddayo(131) = wshddayo(131) + HPN_HTD
   		wshddayo(132) = wshddayo(132) + HPN_dry		
		do ii=1,mstdo
