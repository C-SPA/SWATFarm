...
!     &             (sol_no3(j1,j), j1 = 1, sol_nly(j))
     ...
     &                 wshddayo(111),wshddayo(114),wshddayo(115),
     &                 wshddayo(116),wshddayo(117),wshddayo(118),   
     &                 wshddayo(119), wshddayo(120),wshddayo(121),
     &                 wshddayo(122),wshddayo(123),wshddayo(124),
     &                 wshddayo(125),wshddayo(126),wshddayo(127),
     &                 wshddayo(128),wshddayo(129),wshddayo(130),
     &                 wshddayo(131),wshddayo(132)
     ...
     &                 wshddayo(45), wshddayo(46), wshddayo(44),        
     &                 wshddayo(40), wshddayo(43), wshddayo(41)
	  !&                 wshddayo(114),wshddayo(115),wshddayo(116),
	  !&                 wshddayo(117),wshddayo(118),wshddayo(119)
       end if
...
6200  format(i5,15f8.2,1x,4f8.2,1x,18f10.3, 1x,f11.3)
      end
