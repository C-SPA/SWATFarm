...
1031  format (//6x,' SUB      GIS  MO DA  YR   AREAkm2',36(a10))
      endif
...
!! write headings to reach output file (output.rch)
 ...
 1042 format (//7x,'RCH      GIS  MO DA   YR     AREAkm2',67a12)
...
!bmp-ri.out
 ...
 1021  format (//'LULC  HRU       GIS  SUB  MGT MO DA   YR',            
     &'   AREAkm2',102(a10))	   
 1030 format (//6x,' SUB      GIS  MON   AREAkm2',36(a10))
 1040 format (//7x,'RCH      GIS   MON     AREAkm2',68a12)
 1041 format (//7x,'RCH      GIS   DAY   DET     AREAkm2',57a12)    
