...
!! set daily reach output
      ...
      rchdy(63,jrch) = manureStore
      rchdy(64,jrch) = manure_barn
	  rchdy(65,jrch) = Norg_barn
	  rchdy(66,jrch) = Nmin_barn
      rchdy(67,jrch) = Porg_barn
      rchdy(68,jrch) = Pmin_barn
      rchdy(69,jrch) = manure_past
	  rchdy(70,jrch) = Norg_past
      rchdy(71,jrch) = Nmin_past
      rchdy(72,jrch) = Porg_past
      rchdy(73,jrch) = Pmin_past
