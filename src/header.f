...
!!    column headers for HRU output file
     ...
     &         "  GW_Q_Dmm"," LATQCNTmm","DEN_NgN/ha","DN_NigN/ha",
     &         "N2_DNgN/ha"," sol_org_n"," sol_N_min"," sol_P_min",
     &         "   TN_barn","   TP_barn","   TN_past","   TP_past",
     &         " Norg_barn"," Nmin_barn"," Porg_barn"," Pmin_barn",
     &         " Norg_past"," Nmin_past"," Porg_past"," Pmin_past",
     &         "   Frt_Man","  HPN_calf","   HPN_HFD","   HPN_HSD",
     &         "   HPN_HTD","   HPN_dry"/)
...
!!    numbers printed to VB interface HRU output file 
     ...
     & 813,823,833,843,853,863,873,883,893,1003,1013,1023,
     & 1033,1043,1053,1063,1073,1083,1093,1103,1113,1123,
     & 1133,1143,1153/)
!!    column headers for subbasin output file
     ...
     &         " DOXQ mg/L"," TNO3kg/ha","   TN_barn","   TP_barn",
     &         "   TN_past","   TP_past"," Norg_barn"," Nmin_barn",
     &         " Porg_barn"," Pmin_barn"," Norg_past"," Nmin_past",
     &         " Porg_past"," Pmin_past","  HPN_calf","   Frt_Man"/)
...
!!    column headers for reach output file
     ...
     &         "    WTMPdegc","Manure_store"," manure_barn",
     &         "   Norg_barn","   Nmin_barn","   Porg_barn",
     &         "   Pmin_barn"," manure_past","   Norg_past",
     &         "   Nmin_past","   Porg_past","   Pmin_past"/)
...
!!    numbers printed to VB interface reach output file 
     ...
     & 794,806,818,830,842,854,866,878,890,902/)
