...
! mlyr = max number of soil layers
	  ...
	  ! added by Moges Berbero 07/15/2015 for GHG's in soil
!! nitrious oxide output for .hru file
      real, dimension (:), allocatable :: nitr_oxide,sol_N_min 
      real, dimension(:) , allocatable :: nitr
      real, dimension(:), allocatable :: n2_den,sol_org_n,sol_P_min
...
!    Drainmod tile equations  01/2006
      ...
      real, dimension (:), allocatable :: num_calf, auto_nstrs, manure_kg
      real, dimension (:), allocatable :: num_HFD,num_HSD,num_HTD,num_dry
...
!!    increased hedr(42) to hedr(45) for output.rch gsm 10/17/2011
      character(len=13) :: heds(102),hedb(36),hedr(57),hedrsv(41)
...
!! Added by MJW for Manure P layer
      real, dimension (:), allocatable :: manwop, manwip,mansop, mansip
	  real, dimension (:), allocatable :: man_dry, man_cov 
	  integer, dimension(:), allocatable :: fwep, ftype
      integer:: manp_flag
  
 !! Instream P Model MW 11/28/12
      real::bfullp_eq, bfullp_mn,bfullp_mx,nd_pflow,ptrans_in,ptrans_out,pdecay
      !!real:: pdecay
      real, dimension (:), allocatable :: epc_lag,sedp_benthos
!!  VSF update MW 11/29/12
      real, dimension (:), allocatable :: VFS_ks

!! added for SWAT-FARM
	  !dairy_flag
      integer::dairy,dairy_flag
	  real :: iCalf
	  ...
	  real:: Nmin_frac,Norg_frac,Porg_frac,Pmin_frac
      real :: TotalNP_barn,TotalNP_past
      !real :: P, N
      !real :: total_N, total_P
      real :: nCalf
      ...
      real :: N_dry
      real :: N_calf
      real :: N_heifer_first_dry
      real :: N_heifer_second_dry
      real :: N_heifer_third_dry
      real :: P_dry
      real :: P_calf
      real :: P_heifer_first_dry
      real :: P_heifer_second_dry
      real :: P_heifer_third_dry
      real :: NP_dry
      real :: NP_calf
      real :: NP_HFD
      real :: NP_HSD
